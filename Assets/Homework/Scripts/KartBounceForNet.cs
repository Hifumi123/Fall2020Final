...
namespace KartGame.KartSystems
{
    ...
    /// </summary>
    [RequireComponent(typeof(ArcadeKartForNet))]
    public class KartBounceForNet : NetworkBehaviour
    {
        /// <summary>
        ...
        void Start()
        {
            kart = GetComponent<ArcadeKartForNet>();
        }
        ...
        [Command]
        private void CmdUpdateFunction()
        {
        ...
        void LateUpdate()
        {
            ...
            CmdLateUpdateFunction();
        }

        [Command]
        private void CmdLateUpdateFunction()
        {
